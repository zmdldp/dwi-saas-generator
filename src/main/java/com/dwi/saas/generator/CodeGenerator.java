...
//        mpg.setTemplateEngine(new FreemarkerTemplateEngine());
        ...
        System.err.println("----------------------------------------------------------------");
        System.err.println("代码已经生成完毕，若您生成的代码不在com.dwi.saas包下，请在nacos中的mysql.yml配置文件中调整以下2个参数：");
        System.err.println("mybatis-plus.typeAliasesPackage");
        System.err.println("mybatis-plus.typeEnumsPackage");
        System.err.println("如：typeAliasesPackage: com.dwi.basic.database.mybatis.typehandler;com.dwi.saas.*.entity;追加你的实体包");
        System.err.println("如：typeEnumsPackage: com.dwi.saas.*.enumeration;追加你的枚举包");
        System.err.println("----------------------------------------------------------------");
        System.err.println(StrUtil.format("若新建的服务有枚举类型的字段，请在saas-oauth-server/pom.xml 中加入{}{}-entity 模块",
