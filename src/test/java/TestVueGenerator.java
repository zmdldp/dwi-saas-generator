...
import com.dwi.saas.generator.VueGenerator;
...
import com.dwi.saas.generator.type.HtmlType;
...
import static com.dwi.saas.generator.model.GenTableColumn.NO;
import static com.dwi.saas.generator.model.GenTableColumn.YES;
...
//        CodeGeneratorConfig build = buildListEntity(fileCreateConfig);
        ...
        // 前端代码的绝对路径
        String vuePath = "/Users/dwi/github/saas-web";
...
//        buildVue(build);
    ...
    private static void buildVue(CodeGeneratorConfig build) {
        ...
        // 生成的代码位于前端项目 src 下的什么路径？  默认是:  src/views/saas
//        vue.setViewsPath("views" + File.separator + "saas");
...
//        keyField.put("readony_", new GenTableColumn("readony_", NO, NO, YES, NO, HtmlType.RADIO_BUTTON));
     ...
     * 生成代码后，会生成如下代码：
     * src/api/Xxx.js
     * src/views/saas/base/xxx/Index.vue
     * src/views/saas/base/xxx/Edit.vue
...
//        build.setLikeTable(new LikeTable("b\\_", SqlLike.RIGHT));
        ...
        // 数据库信息
        build.setUrl("jdbc:mysql://127.0.0.1:3306/saas_extend_0000?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull");
     ...
     * 生成代码后，会生成如下代码：
     * src/api/Xxx.js
     * src/views/saas/base/xxx/Tree.vue
     * src/lang/lang.js (该文件中的代码分别复制到 en.js 和 zh.js， 然后删除自己！)
     *
     * @return
     */
