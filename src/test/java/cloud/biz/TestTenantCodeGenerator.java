...
//        String path = System.getProperty("user.dir");
        String path = "/Users/dwi/gitee/saas-cloud-plus/saas-tenant";
        System.out.println("输出路径：");
        System.out.println(path);
        build.setProjectRootPath(path);
        build.setProjectPrefix("saas-");
        // 指定全部代码的生成策略
        ...
        build.setPackageBase("com.dwi.saas." + build.getChildModuleName());
    ...
    public static CodeGeneratorConfig buildHeheEntity() {
        ...
        CodeGeneratorConfig build = CodeGeneratorConfig.
                build("haha", "hehe", "dwi", "m_", tables);
        build.setSuperEntity(EntityType.ENTITY);
        build.setChildPackageName("");
        build.setUrl("jdbc:mysql://127.0.0.1:3306/saas_base_0000?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull");
        return build;
    }
...
//        build.setSuperMapperClass(SuperClass.SUPER_CACHE_CLASS.getMapper());
        ...
        // 子包名
        build.setChildPackageName("");
        build.setUrl("jdbc:mysql://127.0.0.1:3306/saas_defaults?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull");
