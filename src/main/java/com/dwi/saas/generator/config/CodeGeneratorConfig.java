package com.dwi.saas.generator.config;


import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.baomidou.mybatisplus.generator.config.po.LikeTable;
import com.dwi.saas.generator.model.GenTableColumn;
import com.dwi.saas.generator.type.EntityFiledType;
import com.dwi.saas.generator.type.EntityType;
import com.dwi.saas.generator.type.SuperClass;
 ...
 * ${packageBase}.domain.entity.${childModuleName}
 * ${packageBase}.domain.enumeration.${childModuleName}
 * ${packageBase}.domain.constant.${childModuleName}
 * ${packageBase}.domain.dto.${childModuleName}
...
public class CodeGeneratorConfig {
    ...
    public static void main(String[] args) {
		System.out.println(new CodeGeneratorConfig().projectRootPath);
	}
    /**
     * 服务名
    ...
    /**
     * 子模块是否单独生成 saas-{childModuleName}-entity模块
     */                                             
     ...
     * 基础包   所有的代码都放置在这个包之下
     */
    String packageBase = "com.dwi.saas.authority";
    /**
     * 子包名称
     ...
     * 项目统一前缀  比如：  cloud-
     */
    private String projectPrefix = "saas-";
     ...
     * 驱动连接的URL
     */
    private String url = "jdbc:mysql://127.0.0.1:3306/saas_base_0000?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull";
    /**
     * 驱动名称
     */
    ...
    public static class Vue {
        private String viewsPath = "views" + File.separator + "saas";
